# Django settings for motivforce project.
...
SECRET_KEY = 'l08(w)t=ad^chyk1&34hbot#+$i31fro7hf%4^fj=0_95jdnxf'
...
ROOT_URLCONF = 'motivforce.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'motivforce.wsgi.application'
...
EMAIL_SUBJECT_PREFIX = '[motivforce] '
...
WAGTAIL_SITE_NAME = 'motivforce'

# Override the search results template for wagtailsearch
WAGTAILSEARCH_RESULTS_TEMPLATE = 'motivforce/search_results.html'